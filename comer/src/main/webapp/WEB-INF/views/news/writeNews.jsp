...
function submitNews(){
    ...
    var formData = new FormData(form);
		...
		$.ajax({
			...
			url:"writeNews_ok.action",
			data:formData, 
			success:function(response){
			 location.href = "/comer/news.action";
			},
    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <form action="" id="writeN" name="writeN" method="POST" enctype="multipart/form-data">   
          		...
          		<tr>
		       	<tr>
		      	 	...
		      	 	<meta name="_csrf" content="${_csrf.token}"> 
			       	 <input type="button" onclick="submitNews();"  class="btn btn-success" value="작성하기">
			       	</td>
       	 		</tr>
