    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <form action="" enctype="multipart/form-data" id="createInfo" name="createInfo">    
          <br><br><br>
          	<table>
          		<tr>
	          		<td>
          	...
          	<table>
		       	<tr>
		      	 	...
		      	 	<meta name="_csrf" content="${_csrf.token}">
			       	 <input type="button" onclick="submitForm();" class="btn btn-success" value="작성하기">
			       	</td>
       	 		</tr>
