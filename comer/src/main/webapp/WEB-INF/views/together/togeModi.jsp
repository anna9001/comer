...
function submitModi(){
    ...
    var formData = new FormData(form);
		...
		$.ajax({
			...
			url:"/comer/togeModi_ok.action",
			data:formData, 
			success:function(response){
			if(response=="N"){ alert("다시 시도하세요");return;};
    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <form action=""id="updateToge" method="POST" enctype="multipart/form-data">    
          <br><br><br>
          	<table>
          		<tr>
	          		<td>
          		...
          		<tr>	
          			...
          			<td >
          			<input type="text" id="place" name="place" value="${boardDTO.place }">
          			 <input type="text" id="eventDate" name="eventDate" value="${boardDTO.eventDate }"  >  
          			</td>
          		</tr>
          		<tr>
	          		<td>
          			...
          			<td colspan="2">    			
          			<textarea style="width:100%;"  rows="15" id="content" name="content">${boardDTO.content }</textarea>          			
          			</td>
          		</tr>
          		<tr>
          			<td>
          			...
          			<td>
          			 <input type="text" id="id" name="id" value="${boardDTO.id }" readonly/>
          			</td>
          		</tr>
          		<tr>
          			<td>
          		...
          		<tr>
		       	<tr>
		      	 	...
		      	 	<input type="hidden" name="no" id="no" value="${boardDTO.no }"/>
			       	 <input type="button" onclick="submitModi();" class="btn btn-success" value="수정하기">
			       	</td>
       	 		</tr>
